import { PiFieldDescriptor, PiField } from "../lib/PiFieldDescriptor";
import { typeBitValue, FieldData } from "../lib";

const
    fields: PiFieldDescriptor[] = [
        new PiFieldDescriptor('name', 'string', true),
        new PiFieldDescriptor('when', 'date', false),
        new PiFieldDescriptor('age', 'integer', true),
        new PiFieldDescriptor('isMale', 'boolean', true),
    ];
...
describe('PiFieldDescriptor', () => {
    ...
    describe('constructors', () => {
        ...
        it('Created with name and numeric data overriding "required"', () => {
            fd = new PiFieldDescriptor('name', typeBitValue.string | FieldData.required, false);
            expect(fd).toBeTruthy();
            expect(fd.name).toEqual('name');
        ...
        it('Created with name, type=integer, required=false', () => {
            fd = new PiFieldDescriptor('name', 'integer', false);
            expect(fd).toBeTruthy();
            expect(fd.name).toEqual('name');
            expect(fd.required).toEqual(false);
            expect(fd.type).toEqual('integer');
        ...
        it('Created with field:PiField', () => {
            let field: PiField = { name: 'name', required: true, isArray: true, comment: 'xpto', type: 'date' };
        ...
        it('Created enum without values', () => {
            let field: PiField = { name: 'xpto', required: true, isArray: true, type: 'enum' };
    ...
    describe('Miscelaneus methods', () => {
        let init = (req: boolean) => fd = new PiFieldDescriptor('name', 'integer', req);
    ...
    describe('Required String Validation', () => {
        ...
        beforeEach(() => fd = new PiFieldDescriptor('name', 'string', true));
    ...
    describe('Required Date Validation', () => {
        let fd: PiFieldDescriptor;
        beforeEach(() => fd = new PiFieldDescriptor('birthdate', 'date', true));
    ...
    describe('Cast To String', () => {
        let fd: PiFieldDescriptor;
        beforeEach(() => fd = new PiFieldDescriptor('address', 'string', true));
    ...
    describe('Cast To Enum', () => {
        let test = (caption: string, val: any, result: any, error: any) => {
            it(caption, () => {
                let data = { sex: val };
                let fd = new PiFieldDescriptor('sex', 'enum', true, ['male', 'female'])
    ...
    describe('Cast To Number', () => {
        ...
        beforeEach(() => fd = new PiFieldDescriptor('weight', 'number', true));
    ...
    describe('Cast To Integer', () => {
        ...
        beforeEach(() => fd = new PiFieldDescriptor('age', 'integer', true));
    ...
    describe('Cast To Date', () => {
        ...
        beforeEach(() => fd = new PiFieldDescriptor('birthdate', 'date', false));
    ...
    describe('Cast To Boolean', () => {
        let fd: PiFieldDescriptor;
        beforeEach(() => fd = new PiFieldDescriptor('isStudent', 'boolean', true));
    ...
    describe('Cast To Any', () => {
        let fd: PiFieldDescriptor;
        beforeEach(() => fd = new PiFieldDescriptor('tag', 'any', true));
    ...
    describe('Cast To Array<Date>', () => {
        let fd: PiFieldDescriptor;
        let err = /cannot be cast to a date/;
        beforeEach(() => fd = new PiFieldDescriptor('datearray', 'date[]', true));
