...
var fields = [
    new PiFieldDescriptor_1.PiFieldDescriptor('str', 'string', true),
    new PiFieldDescriptor_1.PiFieldDescriptor('int1', 'integer', false),
    new PiFieldDescriptor_1.PiFieldDescriptor('num', 'number', false),
    new PiFieldDescriptor_1.PiFieldDescriptor('bools', 'boolean[]', true),
    new PiFieldDescriptor_1.PiFieldDescriptor('date1', 'date', true),
    new PiFieldDescriptor_1.PiFieldDescriptor('any1', 'any', false),
    new PiFieldDescriptor_1.PiFieldDescriptor('nums', 'number[]', true),
    new PiFieldDescriptor_1.PiFieldDescriptor('enum', 'enum', true, ['value1', 'value2', 'value3']),
    new PiFieldDescriptor_1.PiFieldDescriptor('int2', 'integer', false)
], rendered = [
...
describe('PiTypeDescriptor', function () {
    ...
    describe('Constructors', function () {
        ...
        it('Created with field array with duplicated names', function () {
            var fieldArray2 = fields.concat([new PiFieldDescriptor_1.PiFieldDescriptor('str', 'integer[]', true)]);
    ...
    describe('Methods', function () {
        ...
        it('Parse with enums', function () {
            fd.parse(rendered);
            fields.forEach(function (f) {
                return expect(fd.get(f.name)).toEqual(f);
            });
        });
        it('Parse without enums', function () {
            var fields2 = fields.filter(function (f) { return f.type != 'enum'; });
